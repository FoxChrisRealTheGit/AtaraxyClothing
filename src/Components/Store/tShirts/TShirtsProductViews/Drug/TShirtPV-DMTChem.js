...
export default class TShirtPVDMTChem extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            color: '',
            size: '',
            name: 'DMT Chemical Symbol - T-Shirt',
        }
    ...
    imageBerry() {
        return this.setState({ cur: DMTBerry, color: 'berry' })
    }
    imageBlue() {
    ...
    imageGreen() {
        return this.setState({ cur: DMTGreen, color: 'green' })
    }
    imageGrey() {
        return this.setState({ cur: DMTGrey, color: 'grey' })
    }
    imageRed() {
        return this.setState({ cur: DMTRed, color: 'red' })
    }
    justPrice(size) {
