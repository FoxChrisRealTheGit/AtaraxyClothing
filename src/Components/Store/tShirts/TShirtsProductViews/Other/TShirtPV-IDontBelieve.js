...
export default class TShirtPVIDontBelieve extends Component {
    ...
    imageWhite() {
        return this.setState({ cur: IDontWhite })
    }
    imageBerry() {
        return this.setState({ cur: IDontBerry })
    }
    imageBlue() {
        return this.setState({ cur: IDontBlue })
    }
    imageBlack() {
        return this.setState({ cur: IDontBlack })
    }
    imageGreen() {
        return this.setState({ cur: IDontGreen })
    }
    imageGrey() {
        return this.setState({ cur: IDontGrey })
    }
    imageRed() {
        return this.setState({ cur: IDontRed })
    }
    justPrice() {
