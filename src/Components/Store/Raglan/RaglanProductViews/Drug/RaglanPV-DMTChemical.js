...
import DMTHeather from '../../../../../Images/raglans/drug/dmtChemical/DMTChemicalStructure_mockup_Heather-BlackBlack.png';
import DMTWhite from '../../../../../Images/raglans/drug/dmtChemical/DMTChemicalStructure_mockup_WhiteBlack.png';
...
export default class RaglanPVIDontBelieve extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            color: '',
            size: '',
            name: 'DMT Chemical Structure - 3/4 Sleeve',
        }
    ...
    imageWhite() {
        return this.setState({ cur: DMTWhite, color: 'white' })
    }
    imageBlack() {
        return this.setState({ cur: DMTBlack, color: 'black' })
    }
    imageHeather() {
        return this.setState({ cur: DMTHeather, color: 'heather' })
    }
    imageBlue() {
        return this.setState({ cur: DMTBlue, color: 'blue' })
    }
    justPrice(size) {
