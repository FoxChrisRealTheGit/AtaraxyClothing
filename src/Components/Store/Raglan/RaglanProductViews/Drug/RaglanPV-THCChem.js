...
export default class RaglanPVTHCChem extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            color: '',
            size: '',
            name: 'THC Chemical Structure - 3/4 Sleeve',
        }
    ...
    imageWhite() {
        return this.setState({ cur: THCWhite, color: 'white' })
    }
    imageBlack() {
        return this.setState({ cur: THCBlack, color: 'black' })
    }
    imageHeather() {
        return this.setState({ cur: THCHeather, color: 'heather' })
    }
    justPrice(size) {
