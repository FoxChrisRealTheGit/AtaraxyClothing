...
import DiscoverWhite from '../../../../../Images/raglans/happiness/discoveryourself/DiscoverYourself_mockup_WhiteBlack.png';
...
export default class RaglanPVDiscoverYourself extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            color: '',
            size: '',
            name: 'Discover Yourself - 3/4 Sleeve',
        }
    ...
    imageWhite() {
        return this.setState({ cur: DiscoverWhite, color: 'white' })
    }
    imageBlack() {
        return this.setState({ cur: DiscoverBlack, color: 'black' })
    }
    imageBlue() {
        return this.setState({ cur: DiscoverBlue, color: 'blue' })
    }
    justPrice(size) {
