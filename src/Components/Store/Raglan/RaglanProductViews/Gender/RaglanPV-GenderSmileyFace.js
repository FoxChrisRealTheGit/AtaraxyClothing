...
export default class RaglanPVGenderSmileyFace extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            color: '',
            size: '',
            name: 'Gender Smiley Face - 3/4 Sleeve',
        }
    ...
    imageWhite() {
        return this.setState({ cur: GenderSmileWhite, color: 'white' })
    }
    imageBlack() {
        return this.setState({ cur: GenderSmileBlack, color: 'black' })
    }
    imageHeather() {
        return this.setState({ cur: GenderSmileHeather, color: 'heather' })
    }
    justPrice(size) {
